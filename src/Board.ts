...
export class Board extends Container {
    ...
    private addDeckArea() {
        ...
        deck.drawRoundedRect(10, 10, this.cardWidth, this.cardHeight, 12);
        deck.endFill();
        ...
        flippedPile.position.set(this.cardWidth + this.spaceBetweenCards + 10, 10)
        flippedPile.endFill();
    ...
    private addFoundationPile() {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            area.position.set((this.cardWidth * 3 + 70 + i * this.spaceBetweenCards) + (i * this.cardWidth), 10)

            this.addChild(area);
            console.log(`Card ${i}`, area.x, area.y)
        }
    }
    ...
    private addCardColumns() {
        for (let i = 0; i < 7; i++) {
            ...
            area.position.set((10 + i * this.spaceBetweenCards) + (i * this.cardWidth), this.cardHeight + this.spaceBetweenCards)
